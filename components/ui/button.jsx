...
// Variants untuk tombol menggunakan CVA
...
// Tombol yang akan menggunakan variants dari CVA
const Button = ({ children, className, variant, size, ...props }) => {
  return (
    <button
      {...props}
      className={cn(buttonVariants({ variant, size }), className)} // Menggabungkan class dari buttonVariants dan class tambahan
    >
      {children}
    </button>
  )
